...
```
cd existing_repo
git remote add origin https://gitlab.com/jumpers3/jumpers_app/jumper.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/jumpers3/jumpers_app/jumper/-/settings/integrations)
