...
import 'package:jumper/src/Bloc/Data/Services/fetch_identities_api_servicec.dart';
import 'package:jumper/src/Bloc/models/simple_model.dart';
import 'package:jumper/src/Core/resources/data_state.dart';
import 'package:jumper/src/Core/services/network/network_exceptions.dart';
import 'package:jumper/src/Core/utils/utils.dart';

class FetchIdentitiesRepository {
  final FetchIdentitiesApiService _fetchIdentitiesApiService =
      Get.put(FetchIdentitiesApiService());

  Future<DataState<List<SimpleModel>>>? fetchIdentities() async {
    try {
      final httpResponse = await _fetchIdentitiesApiService.fetchIdentities();
      if (((httpResponse.statusCode == HttpStatus.ok) ||
        ...
        if (httpResponse.data['data'] != null) {
          ...
          printDM(
              "httpResponse.data['data'] in AdminRolesRepository is ${httpResponse.data['data']}");
