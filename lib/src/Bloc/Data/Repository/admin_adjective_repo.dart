...
import 'package:jumper/src/Bloc/Data/Services/fetch_admin_adjective_api_servicec.dart';
import 'package:jumper/src/Bloc/models/simple_model.dart';
import 'package:jumper/src/Core/resources/data_state.dart';
import 'package:jumper/src/Core/services/network/network_exceptions.dart';
import 'package:jumper/src/Core/utils/utils.dart';

class AdminAdjectiveRepository {
  final AdminAdjectiveApiService _adminAdjectiveApiService =
      Get.put(AdminAdjectiveApiService());

  Future<DataState<List<SimpleModel>>>? fetchAdminRoles() async {
    try {
      final httpResponse =
          await _adminAdjectiveApiService.fetchAdminAdjective();
