...
import 'package:jumper/src/Bloc/Data/Services/fetch_sectors_api_servicec.dart';
import 'package:jumper/src/Bloc/models/simple_model.dart';
import 'package:jumper/src/Core/resources/data_state.dart';
import 'package:jumper/src/Core/services/network/network_exceptions.dart';
import 'package:jumper/src/Core/utils/utils.dart';

class FetchSectorsRepository {
  final FetchSectorsApiService _fetchSectorsApiService =
      Get.put(FetchSectorsApiService());

  Future<DataState<List<SimpleModel>>>? fetchSectors() async {
    try {
      final httpResponse = await _fetchSectorsApiService.fetchSectors();
