...
import 'package:jumper/src/Bloc/Data/Services/fetch_work_activity_api_servicec.dart';
import 'package:jumper/src/Bloc/models/simple_model.dart';
import 'package:jumper/src/Core/resources/data_state.dart';
import 'package:jumper/src/Core/services/network/network_exceptions.dart';
import 'package:jumper/src/Core/utils/utils.dart';

class FetchWorkActivityRepository {
  final FetchWorkActivityApiService _fetchWorkActivityApiService =
      Get.put(FetchWorkActivityApiService());

  Future<DataState<List<SimpleModel>>>? fetchWorkActivity() async {
    try {
      final httpResponse =
          await _fetchWorkActivityApiService.fetchWorkActivity();
