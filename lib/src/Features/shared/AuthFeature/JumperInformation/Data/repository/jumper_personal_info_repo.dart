...
import 'package:jumper/src/Features/shared/AuthFeature/JumperInformation/Data/services/jumper_personal_info_api_servicec.dart';

class JumperPersonalInfoRepository {
  final JumperPersonalInfoApiService _jumperPersonalInfoApiService =
      Get.put(JumperPersonalInfoApiService());

  Future<DataState<UserModel>>? enterJumperPersonalInfo(
      {required JumperPersonalInfoRequestParams params}) async {
    try {
      final httpResponse = await _jumperPersonalInfoApiService
          .enterJumperPersonalInfo(params: params);
