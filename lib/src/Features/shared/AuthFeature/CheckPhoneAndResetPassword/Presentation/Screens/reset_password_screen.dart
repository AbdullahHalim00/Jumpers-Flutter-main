...
import 'package:jumper/src/Features/shared/AuthFeature/CheckPhoneAndResetPassword/Logic/reset_password_controller.dart';
...
class ResetPasswordScreen extends StatelessWidget {
  ...
  const ResetPasswordScreen({required this.phone, Key? key}) : super(key: key);
