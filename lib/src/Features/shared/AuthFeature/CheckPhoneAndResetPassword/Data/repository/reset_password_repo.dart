...
import 'package:jumper/src/Features/shared/AuthFeature/CheckPhoneAndResetPassword/Data/services/reset_password_api_servicec.dart';

class ResetPasswordRepository {
  final ResetPasswordApiService _resetPasswordApiService =
      Get.put(ResetPasswordApiService());

  Future<DataState<UserModel>>? resetPassword(
      {required ResetPasswordRequestParams params}) async {
    try {
      final httpResponse =
          await _resetPasswordApiService.resetPassword(params: params);
