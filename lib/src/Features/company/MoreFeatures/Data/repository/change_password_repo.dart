...
import 'package:jumper/src/Features/company/MoreFeatures/Data/services/change_password_api_servicec.dart';

class ChangePasswordRepository {
  final ChangePasswordApiService _changePasswordApiService =
      ChangePasswordApiService();

  Future<DataState<UserModel>>? changePassword(
      {required ChangePasswordRequestParams params}) async {
    try {
      final httpResponse =
          await _changePasswordApiService.changePassword(params: params);
