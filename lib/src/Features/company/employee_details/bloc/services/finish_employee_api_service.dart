...
class FinishEmployeeApiService with ApiNames {
  final NetworkService _networkService = NetworkService();

  Future<Response> fire(FinishEmployeeParams params) async {
    Response response;
    try {
      response = await _networkService.post(
          url: uRLFinishEmployeeWork, auth: true, body: params.toMap());
