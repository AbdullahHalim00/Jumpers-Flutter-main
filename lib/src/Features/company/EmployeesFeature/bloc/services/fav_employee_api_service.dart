...
class FavEmployeeApiService with ApiNames {
  final NetworkService _networkService = NetworkService();

  Future<Response> favourite({required int employeeID}) async {
    Response response;

    try {
      response =
          await _networkService.post(url: uRLFavEmployee, auth: true, body: {
