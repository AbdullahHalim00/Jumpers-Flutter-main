...
import 'package:jumper/src/Features/company/EmployeesFeature/bloc/services/my_employee_api_service.dart';

/// NEEDS TO BE REVIEWED
class MyEmployeesRepository {
  final MyEmployeesApiService _myEmployeesApiService =
      Get.put(MyEmployeesApiService());

  Future<DataState<List<EmployeeModel>>>? getMyEmployees() async {
    try {
      final httpResponse = await _myEmployeesApiService.getMyEmployees();
