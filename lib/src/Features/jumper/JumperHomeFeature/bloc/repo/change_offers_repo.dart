...
import 'package:jumper/src/Features/jumper/JumperHomeFeature/bloc/services/change_offers_status_service.dart';

class ChangeOffersRepo {
  final ChangeOffersStatusApiService _changeOffersStatusApiService =
      Get.put(ChangeOffersStatusApiService());

  Future<DataState<bool>>? changeStatus() async {
    try {
      final httpResponse = await _changeOffersStatusApiService.changeStatus();
