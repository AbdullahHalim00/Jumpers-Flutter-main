...
class IdentitiesBottomSheet extends StatelessWidget {
  final Function(int, String) onSave;
  final int idSelected;

  const IdentitiesBottomSheet({
  ...
  Widget build(BuildContext context) {
    return GetBuilder<FetchIdentitiesController>(
      builder: (_) {
        return Column(
          children: [
            Padding(
                          ...
                          return InkWell(
                            onTap: () {
                              if (_.identityID ==
                                ...
                                _.setIdentitiesID(0);
                                _.setIdentitiesTitle('');
                              } else {
                                _.setIdentitiesID(_.dataState!.data![index].id);
                                _.setIdentitiesTitle(
                            ...
                            child: SingleChoiceRowForm(
                              ...
                              isSelected:
                                  _.identityID == _.dataState!.data![index].id,
                            ),
                          );
                        },
