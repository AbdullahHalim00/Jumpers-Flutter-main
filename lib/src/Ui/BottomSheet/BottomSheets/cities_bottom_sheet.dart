...
class CitiesBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<FetchCitiesController>(
      builder: (_) {
                  ...
                  ? Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return InkWell(
                            onTap: () {
                              if (_.cityID == _.dataState!.data![index].id) {
                                _.setCityID(0);
                                _.setCityTitle('');
                              } else {
                                _.setCityID(_.dataState!.data![index].id);
                                _.setCityTitle(_.dataState!.data![index].title);
                              }
                            },
                            child: SingleChoiceRowForm(
                              title: _.dataState!.data![index].title,
                              isSelected:
                                  _.cityID == _.dataState!.data![index].id,
                            ),
                          );
                        },
