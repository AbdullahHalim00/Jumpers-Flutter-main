...
class SectorsBottomSheet extends StatelessWidget {
  final Function(int, String) onSave;

  const SectorsBottomSheet({
  ...
  Widget build(BuildContext context) {
    return GetBuilder<FetchSectorsController>(
      builder: (_) {
                  ...
                  ? Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return InkWell(
                            onTap: () {
                              if (_.sectorID == _.dataState!.data![index].id) {
                                _.setSectorID(0);
                                _.setSectorTitle('');
                              } else {
                                _.setSectorID(_.dataState!.data![index].id);
                                _.setSectorTitle(
                            ...
                            child: SingleChoiceRowForm(
                              ...
                              isSelected:
                                  _.sectorID == _.dataState!.data![index].id,
                            ),
                          );
                        },
