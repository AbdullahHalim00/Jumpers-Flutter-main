...
class AdminAdjectiveBottomSheet extends StatelessWidget {
  final Function(int, String) onSave;

  const AdminAdjectiveBottomSheet({
  ...
  Widget build(BuildContext context) {
    return GetBuilder<AdminAdjectiveController>(
      builder: (_) {
                  ...
                  ? Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return InkWell(
                            onTap: () {
                              if (_.adminAdjectiveID ==
                                  _.dataState!.data![index].id) {
                                _.setAdminAdjectiveID(0);
                                _.setAdminAdjectiveTitle('');
                              } else {
                                _.setAdminAdjectiveID(
                                    _.dataState!.data![index].id);
                                _.setAdminAdjectiveTitle(
